...
echo [1/4] Reinstalling setuptools with pkg_resources...
venv\Scripts\python.exe -m pip uninstall setuptools -y
venv\Scripts\python.exe -m pip install setuptools==69.5.1
