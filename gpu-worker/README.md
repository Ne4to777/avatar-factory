...
- Устанавливает PyTorch 2.1.0 с поддержкой CUDA 11.8
...
| **PyTorch 2.1.0 + CUDA** | Глубокое обучение на GPU (совместимо с mmcv/MuseTalk) |
...
4. PyTorch 2.1.0: `pip install torch==2.1.0 torchvision==0.16.0 torchaudio==2.1.0 --index-url https://download.pytorch.org/whl/cu118`
...
Документация:
- [Next.js API](../docs/API.md) — основное приложение
- [Архитектура](../docs/PROJECT_SUMMARY.md) — обзор проекта
